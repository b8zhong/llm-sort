...
class AttributeSorting:
        ...
        if categories is None:
            ...
            for cat in categories:
                if cat not in self.CATEGORIES:
                    raise ValueError(f"Unknown category: {cat}. Available categories: {list(self.CATEGORIES.keys())}")
    ...
    def evaluate_answer(self, model_answer: str, correct_answer: str, metadata: Dict) -> Dict:
        """
